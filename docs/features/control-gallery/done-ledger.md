...
| Independent review | UNTESTED | One review returned `REQUEST_CHANGES` on `d3bd907` because the focus assertion allowed a user-agent outline. Correction `934122f` passed the full gate and awaits renewed review. |
